...
def run_metric(output_dir, name, case_pos, ctrl_pos):
    ...
    R_script_url = "https://raw.githubusercontent.com/sorensandgaard/ob_anonymization_R2_RCD/main/read_count_difference.R"
    script_R_file = os.path.join(output_dir, f'read_count_difference.R')
